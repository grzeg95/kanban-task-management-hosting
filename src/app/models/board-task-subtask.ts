...
export class BoardTaskSubtask {
  ...
  } as FirestoreDataConverter<BoardTaskSubtask>;
  ...
  private static _snapToThis(snap: firestoreDocumentSnapshot<BoardTaskSubtask | DocumentData> | storeDocumentSnapshot) {
